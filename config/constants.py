...
AAVE_ETH_TVR_RELATED_TOKEN = ["WETH"]
AAVE_ETH_RELATED_TOKEN = AAVE_ETH_TVR_RELATED_TOKEN + ["wstETH"]
SAMPLE_SYSTEM_TOKEN = (
    MAKERDAO_ETH_RELATED_TOKEN + LIDO_ETH_RELATED_TOKEN + AAVE_ETH_RELATED_TOKEN
)
SAMPLE_SYSTEM_TVR_TOKEN = (
    MAKERDAO_ETH_TVR_RELATED_TOKEN
    + LIDO_ETH_TVR_RELATED_TOKEN
    + AAVE_ETH_TVR_RELATED_TOKEN
)
# --------------------------------------------
